...
try:
    from .enhanced_store_component_fixed_v2 import EnhancedStoreComponent, create_enhanced_store_component
except ImportError:
    try:
        from enhanced_store_component_fixed_v2 import EnhancedStoreComponent, create_enhanced_store_component
    except ImportError:
        # Fallback enhanced store component for testing
        class EnhancedStoreComponent:
...
class EnhancedStoreComponentRegistry:
        ...
        try:
            ...
            if component_class:
                if component_class == EnhancedStoreComponent:
                    ...
                    # Create component directly to ensure proper initialization
                    component = EnhancedStoreComponent(component_name, config)
                    
                    # Validate the component was created correctly
                    if hasattr(component, 'is_v5_enhanced') and component.is_v5_enhanced:
                        return component
                    else:
                        logger.error(f"Created component {component_name} does not have V5 enhancement")
                        return None
                else:
    ...
    def validate_v5_integration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if test_component and isinstance(test_component, EnhancedStoreComponent):
                validation_result["component_creation_success"] = True
                
                # Validate the component has V5 features
                if hasattr(test_component, 'is_v5_enhanced') and test_component.is_v5_enhanced:
                    validation_result["v5_features_verified"] = True
                else:
                    validation_result["validation_errors"].append("Created component missing V5 enhancement flag")
            else:
