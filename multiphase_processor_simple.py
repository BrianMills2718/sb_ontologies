...
SIMPLE_PROMPT = """Extract key theoretical terms from this academic paper and classify each as:
...
Also provide citation, 2-sentence annotation, and recommend the best model type.

Be concise - extract only the most important 20-30 terms."""
