...
from .prompt_loader import get_phase1_prompt, get_phase2_prompt, get_phase3_prompt
...
PHASE1_PROMPT = get_phase1_prompt()
PHASE2_PROMPT = get_phase2_prompt()
PHASE3_PROMPT = get_phase3_prompt()
...
def phase3_generate_schema(phase1_output: Phase1Output, phase2_output: Phase2Output) -> Phase3Output:
    ...
    # Create detailed classification summary with FULL Phase 1 vocabulary
...
COMPLETE PHASE 1 VOCABULARY ({len(phase1_output.vocabulary)} terms):
...
IMPORTANT: Your schema MUST include ALL terms from the Phase 1 vocabulary above.
"""
...
def convert_to_yaml_format(phase1: Phase1Output, phase2: Phase2Output, phase3: Phase3Output) -> Dict:
    ...
    elif phase3.model_type == "hypergraph":
        yaml_output["schema_blueprint"]["root_properties"] = {
            "vertices": {"description": "Vertices/nodes in the hypergraph", "item_type": "Entity"},
            "hyperedges": {"description": "N-ary relationships connecting multiple vertices", "item_type": "Hyperedge"},
            "atoms": {"description": "Atomic semantic units if using SH model", "item_type": "Atom"},
            "connectors": {"description": "Leading elements defining hyperedge semantics", "item_type": "Connector"}
        }
